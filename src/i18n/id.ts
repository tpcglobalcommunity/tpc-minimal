const id = {
  ...
  "public.home.subtitle":
    "Wadah global tempat trader profesional berkumpul, belajar, dan berkembang—berbasis transparansi dan hasil nyata.",
  ...
  "public.footer.rights": "© {year} TPC Global Community. Hak cipta dilindungi.",
} as const;
